package com.cj.common.utils.excle;//package com.cj.witcommon.utils.excle;
//
//import java.io.OutputStream;
//import java.net.URLEncoder;
//import java.config.ArrayList;
//import java.config.HashMap;
//import java.config.List;
//import java.config.Map;
//
...
//import cn.mos.framework.base.config.SessionBean;
...
//	public @ResponseBody EasyUIPage  queryList(SessionBean sessionBean, EasyUIPage page,ZrsBean config,
//			@RequestParam(value = "rows", required = false) Integer rows) {
//		sessionBean = getSessionBean(sessionBean);
//		page.setPagePara(rows);
//		OrgOrganization org = null;
//		String orgCode=config.getFqdwid();
//		boolean  city = false;
...
//					city = true;
//					config.setBqddwbmid(org.getOrgcode());
//					config.setXt_lrrszgsid(org.getOrgcode());
//					config.setFqdwid(null);
//				//县级及以下所有数据 单根据setXt_lrrxgsid 可以查询
//				}else if(OrgUtils.ORGLEVEL_XGS.equals(orglevel)){
//					config.setXt_lrrxgsid(org.getOrgcode());
//					config.setZrslx("01");
//					config.setBqddwbmid(org.getOrgcode());
//					config.setFqdwid(null);
//				//省级数据以下所有数据 只需要 Xt_lrrdwid 即可
//				}else if(OrgUtils.ORGLEVEL_SGS.equals(orglevel)){
//					config.setXt_lrrdwid(org.getOrgcode());
//					config.setFqdwid(null);
//				}else if(OrgUtils.ORGLEVEL_SGSBM.endsWith(orglevel)){
//					config.setFqbmid(org.getOrgcode());
//					config.setFqdwid(null);
//				}
//				else if(OrgUtils.ORGLEVEL_SZGSBM.endsWith(orglevel)){
//					city = true;
//					config.setQdrbmdmArray(org.getOrgcode());
//					config.setFqbmid(org.getOrgcode());
//					config.setFqdwid(null);
//				}else{
//					config.setQdrbmdmArray(config.getQdrbmdmArray());
//					config.setZrslx("01");
//					config.setFqbmid(org.getOrgcode());
//					config.setFqdwid(null);
//				}
...
//			if ( OrgUtils.ORGLEVEL_SZGS.equals(orglevel)){
//				city = true;
//				config.setBqddwbmid(config.getFqdwid());
//			}else if(OrgUtils.ORGLEVEL_XGS.equals(orglevel)){
//				config.setXt_lrrxgsid(org.getOrgcode());
//				config.setZrslx("01");
//				config.setBqddwbmid(org.getOrgcode());
...
//			return new EasyUIPage();
//		}
//		page = zrsService.queryList(config,page,city);
//
...
//	public @ResponseBody Map<String,Object> delete(ZrsBean config,SessionBean sessionBean) {
//		Map<String, Object> map = new HashMap<String, Object>();
//		sessionBean = getSessionBean(sessionBean);
//		try {
//			String resuleses = zrsService.del(config,sessionBean);
...
//		modelAndView.addObject("config", zrsService.querySingle(id));
//		return modelAndView;
//	}
//
...
//		}
//		mv.addObject(AppConst.MESSAGES, JsonUtil.gson.toJson(model));
//		return mv;
//	}
//
...
//		modelAndView.addObject("config", zrsBean);
...
//
//	@RequestMapping("/save")
//	public ModelAndView save(ZrsBean config, SessionBean sessionBean){
//		sessionBean = getSessionBean(sessionBean);
//		ModelAndView mv = new ModelAndView(getViewName(sessionBean));
//		Map<String, Object> model = new HashMap<String, Object>();
//		try {
...
//					    char[] chars = config.getQdnr().toString().toCharArray();
//					    for (int i = 0; i < chars.length; i++) {
//					    	if((int)chars[i]> 31 || (int)chars[i] < 14){
//							            sbu.append(chars[i]);
//					    	}
//					    }
//					config.setQdnr(sbu.toString());
//					zrsService.save(config, sessionBean);
//			}
//			model.put(AppConst.STATUS, AppConst.SUCCESS);
//			model.put(AppConst.MESSAGES, getAddSuccess());
//		} catch (RuntimeException e) {
...
//		ZrsBean config = JSON.parseObject(entityData, new TypeReference<ZrsBean>(){});
//		if	("false".equals(isdel)){
//			List<ZrsqdrBean> zrsqdrBeans = JSON.parseArray(zrsqdrentityData, ZrsqdrBean.class);
//			try {
//				zrsService.saveDataFromProvice(config, zrsqdrBeans, sessionBean);
//				map.put(AppConst.STATUS, AppConst.SUCCESS);
//				map.put(AppConst.MESSAGES, getAddSuccess());
//			} catch (RuntimeException e) {
//				logger.error(e.getLocalizedMessage(), e);
...
//			try {
//				zrsService.delFromProvince(config,sessionBean);
//				map.put(AppConst.STATUS, AppConst.SUCCESS);
//				map.put(AppConst.MESSAGES, getAddSuccess());
//			} catch (Exception e) {
//				logger.error(e.getLocalizedMessage(), e);
...
//		}
//
//		ZrsqdrBean config = JSON.parseObject(entityData, new TypeReference<ZrsqdrBean>(){});
//		SessionBean sessionBean = JSON.parseObject(sessionData, new TypeReference<SessionBean>(){});
//		try {
//			zrsService.saveDataFromCity(config, sessionBean);
//			map.put(AppConst.STATUS, AppConst.SUCCESS);
//			map.put(AppConst.MESSAGES, getAddSuccess());
//		} catch (RuntimeException e) {
//			logger.error(e.getLocalizedMessage(), e);
