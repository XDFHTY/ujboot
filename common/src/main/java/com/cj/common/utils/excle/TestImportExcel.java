package com.cj.common.utils.excle;
...
public class TestImportExcel
{
    ...
    public static void main(String[] args) throws IOException, Exception
    {
        ...
        InputStream in = new FileInputStream(new File("D:file/oil/test.xlsx"));
...
//            System.out.println(readDateT);
            ...
            List<StudentBaseInfo> readDateListT = ImportExeclUtil.readDateListT(wb, studentBaseInfo, 0, 0,i);
