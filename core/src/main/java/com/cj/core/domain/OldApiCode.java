...
public class OldApiCode {
    ...
    public static final int account_not_error = 1003;
    public static final String account_not_error_MSG =  "用户名不存在或者密码错误";
    public static final int account_expiration_error = 1004;
    public static final String account_expiration_error_MSG =  "账号已过期";
    ...
    public static final int role_exist = 1010;
    public static final String role_exist_MSG =  "角色已存在";
    public static final int role_admin_exist = 1011;
